 ...
 */
router.get('/expiring/:days', auth, async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/by-location/:location', auth, async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/by-category/:category', auth, async (req: Request, res: Response) => {
  try {
